...
public class BankApp extends JFrame implements ActionListener {
    ...
    public BankApp() {
        ...
        this.setTitle("Bank User Transaction App");
    ...
    private void setupCommands() {
        ...
        // Withdraw button
        this.btnTransaction = new JButton(" confirm Transaction");
        ...
        this.btnCalcInterest = new JButton("Interest");
    ...
    private void applyInterest() {
        try {
            ...
            if (account instanceof SavingAccount) {
                double interest = ((SavingAccount) account).calcInterest();
    ...
    private void createAccount() {
        ...
        if (this.radChecking.isSelected()) {
            ...
            // Savings
            account = new SavingAccount(Bank.getNextAccountNumber(),
